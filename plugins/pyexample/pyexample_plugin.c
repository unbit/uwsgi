...
113,44,32,34,50,48,48,32,79,75,34,44,32,54,41,10,
...
100,95,104,101,97,100,101,114,40,119,115,103,105,95,114,101,113,44,32,34,67,
111,110,116,101,110,116,45,116,121,112,101,34,44,32,49,50,44,32,34,116,101,120,
116,47,104,116,109,108,34,44,32,57,41,10,
...
static void _cffi_start_and_call_python(struct _cffi_externpy_s *externpy,
                                        char *args) {
  ...
  if (fnptr == NULL) {
    fprintf(stderr,
            "function %s() called, but initialization code "
            "failed.  Returning 0.\n",
            externpy->name);
...
/*  0 */ _CFFI_OP(_CFFI_OP_FUNCTION, 10), // int()(struct wsgi_request *)
/*  1 */ _CFFI_OP(_CFFI_OP_POINTER, 12), // struct wsgi_request *
/*  2 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  3 */ _CFFI_OP(_CFFI_OP_FUNCTION, 10), // int()(void)
/*  4 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  5 */ _CFFI_OP(_CFFI_OP_FUNCTION, 14), // void()(struct wsgi_request *)
/*  6 */ _CFFI_OP(_CFFI_OP_NOOP, 1),
/*  7 */ _CFFI_OP(_CFFI_OP_FUNCTION_END, 0),
/*  8 */ _CFFI_OP(_CFFI_OP_POINTER, 0), // int(*)(struct wsgi_request *)
/*  9 */ _CFFI_OP(_CFFI_OP_POINTER, 3), // int(*)(void)
/* 10 */ _CFFI_OP(_CFFI_OP_PRIMITIVE, 7), // int
/* 11 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 0), // struct uwsgi_server
/* 12 */ _CFFI_OP(_CFFI_OP_STRUCT_UNION, 1), // struct wsgi_request
/* 13 */ _CFFI_OP(_CFFI_OP_POINTER, 5), // void(*)(struct wsgi_request *)
...
static const struct _cffi_struct_union_s _cffi_struct_unions[] = {
  { "uwsgi_server", 11, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
  { "wsgi_request", 12, _CFFI_F_OPAQUE,
    (size_t)-1, -1, -1, 0 /* opaque */ },
};
