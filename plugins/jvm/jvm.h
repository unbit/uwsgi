...
jobject       uwsgi_jvm_utf8(const char *);
...
jobject       uwsgi_jvm_tostring(jobject);
jobject       uwsgi_jvm_string_from(char *, int length);
...
void          uwsgi_jvm_print(jobject);
void          uwsgi_jvm_println(jobject);
